...
class RegistrationForm(UserCreationForm):
    email = forms.EmailField(max_length=254, help_text='Requeridos. Adicionar um endereço de email válido.')
...
class AccountUpdateForm(forms.ModelForm):
    ...
    def clean_email(self):
        ...
        try:
            ...
            return email
        raise forms.ValidationError('Email "%s" já está em uso.' % account)
